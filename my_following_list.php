        ...
        <div class="container-fluid mt-3">
            <div class="row">
                ...
                <div class="following_list col-lg-6">
                    ...
                    <?php
                        $following_users_list = $SNS->displayFollowing($current_login_id);
                                ...
                                ?>  
                                    <div class="float-right">
                                        <form action="action.php" method="post">
                                            ...
                                            <button type="submit" name="unfollow_in_myfollowing_list" class="btn btn-outline-primary" style="border-radius: 25px;">Unfollow</button>
                                        </form>
                                    </div>
                                <?php } ?>
                            </div>
